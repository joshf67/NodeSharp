...
public class TriggerCustomEventNode : Node, IActionNode
{
    public TriggerCustomEventNode(ScriptBrain brain, VariableData data) : base(brain, NodeTypes.TriggerCustomEvent)
    {
