...
public class OnCustomEventGlobalNode : Node, IActionNode
{
    public OnCustomEventGlobalNode(ScriptBrain brain, VariableData data) : base(brain, NodeTypes.OnCustomEventGlobal)
    {
