...
public class AddNumberNode : Node, GetterInterface
{
    public AddNumberNode(ScriptBrain brain, GetterInterface a, GetterInterface b) : base(brain, NodeTypes.Add_Number)
    {
